...
const FilesList = () => {
  ...
  const rows = files.map((files) => files);
      ...
      <div className=" w-full">
        <div className="w-full flex md:flex-wrap gap-y-3 sm:flex-nowrap justify-between pb-5 border-b border-primary">
          ...
          <div className="w-full flex justify-end sm:w-fit">
            <Link to="/files" className="flex gap-2 h-fit items-center px-2.5 md:px-2 sm:px-4 rounded-xl py-2.5 bg-primary hover:bg-hover text-white">
              <IoMdAdd size={22} />
          ...
          <div className="-m-1.5 overflow-x-auto">
            <div className="p-1.5 min-w-full align-middle">
              <TableComponent
                ...
                tableData={(data) => setFiles (data.events)}
                rows={rows}
                apiUrl={'events'}
