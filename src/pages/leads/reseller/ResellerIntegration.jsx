...
const ResellerIntegration = () => {
  const sections = [
    ...
    "mobile": "+1234567890",
    "ccode": "91",
    "resellerMessage": "This is a sample message.",
  ...
  return <ApiIntegrationComponent sections={sections} href={'/reseller/reseller-list'} />;
};

export default ResellerIntegration;
