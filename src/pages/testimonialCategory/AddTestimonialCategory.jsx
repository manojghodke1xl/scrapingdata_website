...
const AddTestimonialCategory = () => {
  ...
  const validate = () => {
    const newErrors = {};
    if (!categoryName) newErrors.name = 'Category Name is required';
    setErrors(newErrors);
  ...
  return (
    <div className="py-8 p-4 sm:p-8 overflow-x-hidden mb-20">
      <div className="w-full pb-8 border-b border-primary gap-y-4 gap-2 flex flex-col items-start md:flex-row lg:flex-col xl:flex-row justify-between lg:items-start md:items-end xl:items-end">
        ...
        <FormButtons to="/testimonial-category/testimonial-category-list" type="submit" onClick={handleSubmit} btnLebal={id ? 'Save Changes' : 'Add'} loading={isLoading} />
      </div>
...
export default AddTestimonialCategory;
