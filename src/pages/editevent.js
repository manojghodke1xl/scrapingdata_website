...
export default function EditEvent() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (res.ok) {
        const { name, description, lastdate, eventdate, hasfood, bookonce, drivelink, variants } = data;
        setName(name);
        setDescription(description);
        setLastdate(lastdate);
        setEventdate(eventdate);
        setHasfood(hasfood);
        setBookonce(bookonce);
      ...
      <div className="container container-tight py-4">
        <div className="card card-md">
          <div className="card-body">
            <h2 className="h2 text-center mb-4">Edit Event Form</h2>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                <label className="form-label required">Photos Link</label>
                <input
                  type="url"
                  className="form-control"
